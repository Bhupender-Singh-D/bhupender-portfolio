      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            {/* Status Pill */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-card border border-blue-500/30 text-blue-600 dark:text-cyan-400 text-xs font-semibold tracking-wide uppercase">
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 pt-4">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-6 py-3.5 rounded-xl font-semibold text-slate-800 dark:text-white glass-card hover:bg-slate-100 dark:hover:bg-slate-800 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200"
              >
          ...
          <div className="lg:col-span-5 flex justify-center relative">
            ...
            <div className="relative w-72 h-72 sm:w-88 sm:h-88 lg:w-96 lg:h-96">
              ...
              <div className="absolute inset-0 rounded-3xl bg-gradient-to-tr from-blue-600 via-purple-600 to-cyan-400 opacity-30 blur-2xl animate-pulse-glow" />

              {/* Profile Card Container */}
              <div className="relative w-full h-full glass-card rounded-3xl p-4 border border-white/20 dark:border-white/10 shadow-2xl flex flex-col justify-between overflow-hidden group">
                
                {/* Header Mock Code Toolbar */}
                <div className="flex items-center justify-between px-3 py-2 border-b border-slate-200 dark:border-slate-800/80 bg-slate-100/50 dark:bg-slate-900/50 rounded-xl">
                ...
                <div className="relative my-4 flex-1 flex flex-col items-center justify-center bg-gradient-to-b from-blue-500/10 to-purple-500/10 rounded-2xl p-6 border border-slate-200/50 dark:border-slate-800/50">
                  ...
                  <div className="mt-4 flex items-center gap-2">
                    <span className="px-2.5 py-1 rounded-md text-[11px] font-mono bg-blue-500/10 text-blue-600 dark:text-blue-400 font-semibold">
                      React.js
                    </span>
                    <span className="px-2.5 py-1 rounded-md text-[11px] font-mono bg-purple-500/10 text-purple-600 dark:text-purple-400 font-semibold">
                      Tailwind
                    </span>
                ...
                <div className="absolute -bottom-2 -left-2 px-3.5 py-2 rounded-2xl glass-card border border-blue-500/30 text-xs font-semibold flex items-center gap-2 shadow-lg animate-float" style={{ animationDelay: '2s' }}>
