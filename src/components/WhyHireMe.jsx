  ...
  return (
    <section className="py-20 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Reasons Cards Grid - 8px Card Radius */}
          ...
          {reasons.map((item, idx) => {
            ...
            return (
              <ScrollReveal key={idx} direction="up" delay={idx * 70}>
                <div
                  className="glass-card p-6 rounded-[8px] border border-slate-200/80 dark:border-slate-800 flex flex-col items-center text-center space-y-4 hover:-translate-y-2 transition-all duration-300 group shadow-lg h-full"
                >
                  <div className={`p-4 rounded-[5px] bg-gradient-to-tr ${item.color} text-white shadow-lg group-hover:scale-110 transition-transform duration-300`}>
